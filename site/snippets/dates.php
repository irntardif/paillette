...
if($representations->isNotEmpty()):
	...
	if(count($formatDates) == 2):
		if($formatDates[0]->date()->toDate('%B %Y') == $formatDates[1]->date()->toDate('%B %Y')):
	...
	elseif(count($formatDates) == 3):
		if( $formatDates[0]->date()->toDate('%B %Y') == $formatDates[1]->date()->toDate('%B %Y') && $formatDates[1]->date()->toDate('%B %Y') == $formatDates[2]->date()->toDate('%B %Y')):
